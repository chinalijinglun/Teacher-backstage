    ...
    <div class="teacher-detail">
        ...
        <div class="teacher-mess">
            ...
            <div class="fir03">
                ...
                <div class="xueli">
                    <div class="xl-tit">学历</div>
                    <div class="xl-name">博士后</div>
                    <div class="xl-name">博士</div>
                    <div class="xl-name">硕士</div>
                    <div class="xl-name">本科</div>
                </div>
                <div class="zdsj">
                ...
                <div class="zdsj">
                    <div class="zdsj-tit">毕业证明</div>
                    <div class="zdsj-name">
                        <div><span>毕业证明 1</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="delet">X</span></div>
                        <div><span>毕业证明 1</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="delet">X</span></div>
                        <button>上传</button>
                    </div>
                    <div class="zdsj-name">
            ...
            <div class="fir04">
                ...
                <div class="week">
                    ...
                    <div class="weeks">周一</div>
                    <div class="weeks">周二</div>
                    <div class="weeks">周三</div>
                    <div class="weeks">周四</div>
                    <div class="weeks">周五</div>
                    <div class="weeks">周六</div>
                    <div class="weeks">周日</div>
                </div>
                <div class="week-time">
                    <div class="weeks-tit">周</div>
                    <div class="weeks">
        ...
        <div class="jyjl">
            <div class="fir02">
                ...
                <div class="pic base">
                    <input type="text" class="widths" placeholder="如果是已经退休的教师或目前不在学校任职，请填写最新一段教学经历">
                </div>
            </div>
            <div class="sknj">
                <div class="names">
...
<style scoped>
    ...
    .xl-tit,.zdsj-tit,.weeks-tit{
        height: 24px;
        line-height: 24px;
        border-bottom: 1px solid #e1e1e1;
        text-align: center;
    }
    .xl-name,.zdsj-name,.weeks{
        min-height: 49px;
        line-height: 49px;
        border-bottom: 1px solid #e1e1e1;
        text-align: center;
    }
    .xl-name:last-child,.zdsj-name:last-child,.weeks:last-child{
        border: none;
    }
    .zdsj{
        width: 15%;
